...
from student_stats import getAveragePerformance, getApprovalStatus, getPercentile, updateStats
        ...
        for question in self.questions:
            ...
            if (self.threshold_type == "Average_Performance"):
                if (quest[i]["difficulty"] == "Beginner"):
                    ...
                    updateStats(self.student_name,
                                question.isCorrect(self.sensors))
